...
const Botanical: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24.39" height="11.052" viewBox="0 0 24.39 11.052">
    <g transform="translate(0 0)">
      ...
      <path style={{fill: "#95cc81"}} d="M24.009,356.76H.381a.381.381,0,0,1,0-.762H24.009a.381.381,0,0,1,0,.762Z" transform="translate(0 -345.708)"/></g></svg>
);
